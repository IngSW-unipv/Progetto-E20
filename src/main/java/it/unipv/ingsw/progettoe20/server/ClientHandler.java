 ...
 * Ogni handler è associato a un solo client.
 */
public class ClientHandler extends Thread {
	...
	/**
	 * Legge il contenuto della socket e verifica la presenza di richieste. Alla
	 * richiesta di chiusura termina la connessione.
	 */
	@Override
	public void run() {
		try {
