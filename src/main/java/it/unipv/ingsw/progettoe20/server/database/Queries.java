...
// GENERAL DB QUERIES
     ...
     */
    public static final String CREATE_TABLE_LEVELS = "CREATE TABLE " + DBConstants.LEVEL_TABLE + " ("
     ...
     */
    public static final String CREATE_TABLE_PRICES = "CREATE TABLE " + DBConstants.PRICES_TABLE + " ("
...
// TICKET QUERIES
     ...
     * stesso ordine.
     */
    public static final String TICKET_NEW = "INSERT INTO " + DBConstants.TICKET_TABLE + " (" + DBConstants.TICKET_FIRST_COLUMN
     ...
     * stesso ordine.
     */
    public static final String TICKET_UPDATE = "UPDATE " + DBConstants.TICKET_TABLE + " SET "
            + DBConstants.TICKET_SECOND_COLUMN + " = ?, " + DBConstants.TICKET_THIRD_COLUMN + " = ?, "
     ...
     * ordine.
     */
    public static final String TICKET_REMOVE = "DELETE FROM " + DBConstants.TICKET_TABLE + " WHERE "
...
// LEVEL QUERIES
     ...
     * stesso ordine.
     */
    public static final String LEVEL_NEW = "INSERT INTO " + DBConstants.LEVEL_TABLE + " (" + DBConstants.LEVEL_FIRST_COLUMN
     ...
     * stesso ordine.
     */
    public static final String LEVEL_UPDATE = "UPDATE " + DBConstants.LEVEL_TABLE + " SET " + DBConstants.LEVEL_SECOND_COLUMN
     ...
     * stesso ordine.
     */
    public static final String LEVEL_REMOVE = "DELETE FROM " + DBConstants.LEVEL_TABLE + " WHERE "
     ...
     * nello stesso ordine.
     */
    public static final String LEVEL_GET = "SELECT * FROM " + DBConstants.LEVEL_TABLE + " " + "WHERE "
            + DBConstants.LEVEL_FIRST_COLUMN + " = ?";

    /**
     * Restituisce la lista dei livelli.
     */
    public static final String LEVEL_GET_LIST = "SELECT * FROM " + DBConstants.LEVEL_TABLE;
...
// PRICE QUERIES
     ...
     * stesso ordine.
     */
    public static final String PRICES_NEW = "INSERT INTO " + DBConstants.PRICES_TABLE + " (" + DBConstants.PRICES_FIRST_COLUMN
     ...
     * stesso ordine.
     */
    public static final String PRICES_UPDATE = "UPDATE " + DBConstants.PRICES_TABLE + " SET " + DBConstants.PRICES_SECOND_COLUMN
     ...
     * stesso ordine.
     */
    public static final String PRICES_REMOVE = "DELETE FROM " + DBConstants.PRICES_TABLE + " WHERE "
            + DBConstants.PRICES_FIRST_COLUMN + " = ?";

    /**
     * Restituisce la lista delle tariffe.
     */
    public static final String PRICES_GET_LIST = "SELECT * FROM " + DBConstants.PRICES_TABLE;
}
